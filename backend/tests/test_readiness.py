...
class ReadinessTests(unittest.TestCase):
    ...
    def test_active_probe_requires_operator_calls_model_once_and_encrypts_evidence(self):
        ...
        self.assertEqual(data["input_inconclusive_components"], [])
        self.assertEqual(data["output_inconclusive_components"], [])
        self.assertEqual(data["final_inconclusive_components"], [])
