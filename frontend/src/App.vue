...
.brand { height:64px; display:flex; align-items:center; gap:11px; padding:8px; border-bottom:1px solid var(--sidebar-line); }
...
.brand-copy strong { color:#f5f9fc; font-size:14px; white-space:nowrap; }
.brand-copy span { font:8px/1.1 ui-monospace, SFMono-Regular, Consolas, monospace; color:#91a9ba; }
...
.nav-active { color:#ffffff !important; background:rgba(8,126,174,.36) !important; border-color:rgba(70,183,224,.34) !important; box-shadow:inset 3px 0 #6fd2e8; }
