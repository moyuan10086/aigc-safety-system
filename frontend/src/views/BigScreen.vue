...
const riskOption = computed<EChartsCoreOption>(() => ({
  backgroundColor: 'transparent', tooltip: { trigger: 'item', confine: true }, color: riskColors,
...
@media(max-width:1199px){.title-lockup{width:430px;gap:8px}.title-wing{height:14px}.screen-title{font-size:22px}.screen-title small{font-size:6px}.screen-kpis>div{padding:0}.screen-kpis strong,.screen-kpis span{font-size:inherit}.situation-foot{display:none}}
</style>
