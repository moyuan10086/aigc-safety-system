  ...
  <div class="settings-page">
    ...
    <section class="card api-card">
      ...
      <div v-if="user" class="api-metrics">
        ...
        <div><span>失败率</span><b>{{ usage.totals.failure_rate }}%</b></div>
        <div><span>P95 延迟</span><b>{{ usage.totals.p95_latency_ms }}ms</b></div>
      </div>
...
const scopeOptions = [
  ...
  { value:'image:audit-watermark', label:'可逆审计副本生成与核验' },
  { value:'image:watermark', label:'隐形水印嵌入与核验' },
