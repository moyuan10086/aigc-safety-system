<template>
  <div class="shadow-review">
    ...
    <div class="queue-head">
      <div><strong>人工复核样本池</strong><span>分歧优先、风险分层；点击取证后才解密原文</span></div>
...
import { ArrowRight, BadgeCheck, CircleAlert, Download, FileSearch, ShieldCheck, ShieldX } from 'lucide-vue-next'
...
.queue-head a{height:28px;margin-left:auto;display:flex;align-items:center;gap:6px;padding:0 9px;color:var(--primary);border:1px solid var(--line);border-radius:5px;font-size:9px;text-decoration:none}.queue-head a:hover{background:var(--surface);border-color:var(--line-bright)}
